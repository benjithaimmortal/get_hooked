...
<h3><a href='<?= admin_url('post.php?post=3&action=edit')?>'>Check out that field</a></h3>
<div class='example'>Your date field is currently: <strong><?= strlen(get_field('almost_mandatory_field')) ? get_field('almost_mandatory_field') : '[blank]'?></strong></div>